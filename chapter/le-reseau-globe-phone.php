        ...
        <div class="ui-controller">
                ...
                <div id="ui-standard" class="ui-standard">
                        <div class="center">
                                ...
                                <p class="title">Le réseau Globe-Phone</p>

                                <p class="content">
                                        C'est un serveur de téléphonie conçu par bee.
                                        L'installation et la configuration est faite via un cahier des charges que
                                        le commanditaire fournit. Les postes sont rattachés aux serveurs et passent
                                        par la connexion internet.
                                </p>
